  ...
  return (
    <div className="prose prose-xs max-w-none prose-slate break-words overflow-wrap-anywhere">
      <ReactMarkdown
        ...
        components={{
          p: ({ children }) => <p className="mb-1 last:mb-0 text-xs leading-relaxed break-words">{children}</p>,
          ul: ({ children }) => <ul className="mb-1 last:mb-0 ml-3 list-disc text-xs break-words">{children}</ul>,
          ol: ({ children }) => <ol className="mb-1 last:mb-0 ml-3 list-decimal text-xs break-words">{children}</ol>,
          ...
          pre: ({ children }) => (
            <pre className="bg-gray-100 p-1 rounded text-xs font-mono overflow-x-auto break-all">{children}</pre>
          ),
          strong: ({ children }) => <strong className="font-semibold text-xs break-words">{children}</strong>,
          ...
          h3: ({ children }) => <h3 className="text-xs font-bold mb-0.5 break-words">{children}</h3>,
          blockquote: ({ children }) => (
            <blockquote className="border-l-2 border-gray-300 pl-2 italic text-xs break-words">{children}</blockquote>
          ),
          a: ({ href, children }) => (
            <a 
              href={href} 
